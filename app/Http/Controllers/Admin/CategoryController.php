...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $auth_user = Auth::user();
        return view('admin.category.index', compact('categories','auth_user'));
    }
    ...
    {
        $auth_user = Auth::user();
        return view('admin.category.create',  compact('auth_user'));
    }
    ...
    {
        $auth_user = Auth::user();
        return view('admin.category.edit', compact('category','auth_user'));
    }
