    ...
    <div class="container-scroller">
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="{{ route('admin.index')}}"><strong>My Admin</strong> </a>
          <a class="navbar-brand brand-logo-mini" href="{{ route('admin.index')}}"><img src="{{ asset('import/assets/admin/images/logo-mini.svg')}}" alt="logo" /></a>
        </div>
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <div class="text-center d-flex align-items-center justify-content-center p-0 m-0">
              <a class="navbar-brand brand-logo p-0 m-0" href="{{ route('admin.index')}}"><img style="width: 50%;" class="p-0 m-0 rounded-circle border" src="{{ asset("storage/$auth_user->profile_pic")}}" alt="logo" /></a>
            </div>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#ui-blogs" aria-expanded="false" aria-controls="ui-basic">
              ...
              <div class="collapse" id="ui-blogs">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.blog-category.index') }}">Post Categories</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.blogs.index') }}">Posts</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
