          ...
          <div class="row">
            ...
            <div class="col-md-7">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea type="text" rows="5" maxlength="255" name="description" class="form-control" placeholder="Enter Project description" value="{{old('description')}}" required></textarea>
                </div>
              </div>
            </div>
            <div class="col-md-7">
            ...
            <div class="col-md-7">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" name="sourceCode_url" class="form-control" placeholder="enter source code url" value="{{old('sourceCode_url')}}" required/>
                </div>
              </div>
            </div>
            <div class="form-group">
