          ...
          <div class="row">
            ...
            <div class="col-md-7">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea type="text" style="height: 150px;" name="description" class="form-control" placeholder="Enter Project description" value="{{old('description')}}" required></textarea>
                </div>
              </div>
            </div>
            <!-- <div class="col-md-7">
