            ...
            <div class="row topspace">
                ...
                <article class="post">
                        ...
                        <div class="entry-content">
                            ...
                            Published on <u>{{ $post->created_at->format('Y/m/d') }} at {{ $post->created_at->format('g:i A') }}</u>
                            </p>
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <div id="comments">
                        ...
                        <div id="respond">
                            ...
                            <form method="POST" id="commentform" class="" action="{{ route('blogs.comment', ['id' => urlencode($post->title), 'replyId' => urlencode('#') ]) }}">
                                @csrf
