	...
	<div class="container">
		...
		<div class="row section featured topspace">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-3 blog">
                    <span class="img">
                        <img src="{{ asset("storage/$p_blog->image") }}" alt="image">
                    </span>
					<h4 class="text-center blog-title" id="latestBlogLimitedTitle">{{ \App\Http\Controllers\Blogs\BlogController::shortText($p_blog->title, 25)}}</h4>
                    <p class="description" id="latestBlogLimitedText">{{ \App\Http\Controllers\Blogs\BlogController::shortText($p_blog->description, 100)}}</p>
					<p class="text-center"><a href="{{ route('blogs.post',['id' => $p_blog->title]) }}" class="btn btn-action">Read more</a></p>
				</div>
				@endforeach
				@else
		...
		<div class="row section featured topspace">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-3 blog">
					...
					<h4 class="text-center blog-title" id="latestBlogLimitedTitle">{{ \App\Http\Controllers\Blogs\BlogController::shortText($blog->title, 25)}}</h4>
                    <p class="description" id="latestBlogLimitedText">{{ \App\Http\Controllers\Blogs\BlogController::shortText($blog->description, 100)}}</p>
					<p class="text-center"><a href="{{ route('blogs.post',['id' => $blog->title]) }}" class="btn btn-action">Read more</a></p>
				</div>
				@endforeach
				@else
				<h3 class="text-center">No Posts Available</h3>
