    ...
    <div class="carousel-item active">
      <div class="container">
        ...
        <div class="row">
          ...
          <center>
            <div class="col-lg-4">
              <div class="card" style="margin: 10px 0 10px 0; box-shadow: 0 0 5px rgba(255, 100, 100, 0);
        ...
        <div class="row">
          ...
          <center>
            <div class="col-lg-4" style="margin-bottom: 10px;">
              <div class="card" style="box-shadow: 0 0 5px rgba(255, 100, 100, 0);
                                          transition: box-shadow 0.3s ease;
                                          padding:5px 0;">
                <span class="img">
                  <img src="{{ asset('storage/'.$category->image) }}" class="card-img-top " alt="Image"
                ...
                <div class="card-body">
                  ...
                  <a href="{{ route('blogs.category', ['title' => $category->id]) }}" class="btn btn-primary">Show
                    Posts</a>
                </div>
              </div>
            </div>
