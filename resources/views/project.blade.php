...
<body>
    ...
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="d-flex">
                <a class="navbar-brand btn-sm btn-success" href="{{ $project->sourceCode_url }}" target="_blank">Source
                    Code</a>
                <a class="navbar-brand btn-sm btn-danger" href="{{ $project->project_url }}" target="_blank">Live
                    Preview</a>
            </div>
        </div>
    </nav> --}}
...
@section('content')
    ...
    <div class="container py-2">
        <div>
            ...
            <a href="{{ $project->sourceCode_url }}" class="mr-3 text-decoration-none text-white"><i
                    class="bi-code me-1"></i>Source Code</a>
            <a href="{{ $project->project_url }}" class="mr-3 text-decoration-none text-white"><i
                    class="bi-eye me-1"></i>Demo</a>
        </div>
        ...
        <div class="card border-0 my-2 py-2">
            ...
            <div class="card-body">
                ...
                <hr>
                <p class="card-text"><small class="text-muted">Last updated on {{ $project->updated_at->format('d-m-Y') }}
                        at {{ $project->updated_at->format('g:i A') }}</small></p>
            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4 portfolio-item {{ $portfolio->category->name }}">
                            <a href="{{ route('project', ['id' => $portfolio->title]) }}">
                                <div class="position-relative overflow-hidden mb-2">
                                    <img class="img-fluid rounded w-100" style="height:400px;"
                                        src="{{ asset("
                                                                        storage/$portfolio->image") }}"
                                        alt="">
...
{{--
    ...
    <div class="container-fluid text-white mt-5 py-5 px-sm-3 px-md-5"
        style="background-color: #191919; background-size: cover; ">
        <div class="container text-center py-5">
            <div class="d-flex justify-content-center mb-4">
                ...
                <a class="btn btn-light btn-social mr-2" target="_blank" href="{{ $setting->linkedin_url }}"><i
            ...
            <p class="m-0">&copy; <span class="text-white font-weight-bold">{{ date('Y') }}</span>. All Rights Reserved.
                Designed by <a class="text-white font-weight-bold" href="{{ route('home') }}">Muhammad Ali Nasir</a>
            </p>
        </div>
    </div>
